...
paymentsModule.factory('Common', [function() {
  var expiryParser = {};
  // expiry is a string "mm / yy[yy]"
  expiryParser['parseExpiry'] = function(value) {
...
paymentsModule.factory('Cards', [function() {
...
paymentsModule.factory('_Format',['Cards', 'Common', '$filter', function(Cards, Common, $filter){
...
paymentsModule.directive('paymentsFormat', ['$window', '_Format', function($window, _Format){
    return {
      restrict: 'A',
      require: 'ngModel',
...
paymentsModule.factory('_Validate', ['Cards', 'Common', '$parse', function(Cards, Common, $parse){
...
paymentsModule.factory('_ValidateWatch', ['_Validate', function(_Validate){
...
paymentsModule.directive('paymentsValidate', ['$window', '_Validate', '_ValidateWatch', function($window, _Validate, _ValidateWatch){
  return {
    restrict: 'A',
    require: 'ngModel',
    link: function(scope, elem, attr, ctrl){
...
paymentsModule.directive('stripeForm', ['$window', '$parse', 'Common', function($window, $parse, Common) {
